# 🎯 Repositórios de Ensemble Learning (2025)
...
- **Uncertainty & Bayesian:** 1 repositórios
...
|---|---|---|---|---|
| 1 | [google-research/google-research](https://github.com/google-research/google-research) | 36627 ⭐ | Jupyter Notebook | Google Research |
| 2 | [NVIDIA/DeepLearningExamples](https://github.com/NVIDIA/DeepLearningExamples) | 14539 ⭐ | Jupyter Notebook | State-of-the-Art Deep Learning scripts organized by models - easy to train and deploy with reproducible accuracy and performance on enterprise-grade infrastructure. |
| 3 | [bloomberg/memray](https://github.com/bloomberg/memray) | 14527 ⭐ | Python | Memray is a memory profiler for Python |
| 4 | [scikit-learn-contrib/imbalanced-learn](https://github.com/scikit-learn-contrib/imbalanced-learn) | 7051 ⭐ | Python |  A Python Package to Tackle the Curse of Imbalanced Datasets in Machine Learning |
| 5 | [google/automl](https://github.com/google/automl) | 6410 ⭐ | Jupyter Notebook | Google Brain AutoML |
| 6 | [airbnb/knowledge-repo](https://github.com/airbnb/knowledge-repo) | 5533 ⭐ | Python | A next-generation curated knowledge sharing platform for data scientists and other technical professions. |
| 7 | [rasbt/mlxtend](https://github.com/rasbt/mlxtend) | 5079 ⭐ | Python | A library of extension and helper modules for Python's data analysis and machine learning libraries. |
| 8 | [scikit-learn-contrib/sklearn-pandas](https://github.com/scikit-learn-contrib/sklearn-pandas) | 2843 ⭐ | Python | Pandas integration with sklearn |
| 9 | [salesforce/TransmogrifAI](https://github.com/salesforce/TransmogrifAI) | 2269 ⭐ | Scala | TransmogrifAI (pronounced trăns-mŏgˈrə-fī) is an AutoML library for building modular, reusable, strongly typed machine learning workflows on Apache Spark with minimal hand-tuning |
| 10 | [uber-research/deep-neuroevolution](https://github.com/uber-research/deep-neuroevolution) | 1657 ⭐ | Python | Deep Neuroevolution |
| 11 | [scikit-learn-contrib/metric-learn](https://github.com/scikit-learn-contrib/metric-learn) | 1425 ⭐ | Python | Metric learning algorithms in Python |
| 12 | [NeuroTechX/moabb](https://github.com/NeuroTechX/moabb) | 862 ⭐ | Python | Mother of All BCI Benchmarks |
| 13 | [dabl/dabl](https://github.com/dabl/dabl) | 727 ⭐ | Jupyter Notebook | Data Analysis Baseline Library |
| 14 | [hendrycks/natural-adv-examples](https://github.com/hendrycks/natural-adv-examples) | 614 ⭐ | Python | A Harder ImageNet Test Set (CVPR 2021) |
| 15 | [OHDSI/PatientLevelPrediction](https://github.com/OHDSI/PatientLevelPrediction) | 210 ⭐ | R | An R package for performing patient level prediction in an observational database in the OMOP Common Data Model. |
